$(function () {
  ...
  function processImage () {
    ...
    // name, y, x
    const textData1 = [`${text1}`, 331, 540];
    // name, y, x
    const textData2 = [`${text2}`, 1028, 355];
  ...
  function createDP(ministerText, personText, cb) {
    ...
    var frameImg = loadImage("./dpEngine/img/frame.png");
